...
# ALIGNRIGHT = "rol"
ALIGNFRONT2 = "xx"#align front with 2 sensors
ALIGNFRONT = "o" # Tell robot to align itself using obstacles on the front
AlIGNFRONTSTAIR = ""#calibrate using middle front and right front sensors to calibrate for staircase, not using currently
